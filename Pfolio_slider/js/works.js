...
$(document).ready(function(){
  ...
  $('.1open').on('click', function(){
    $('.overlay, .1frame, .close').fadeIn('slow');
  });

  $('.2open').on('click', function(){
    $('.overlay2, .2frame, .close').fadeIn('slow');
  });

  $('.4open').on('click', function(){
    $('.overlay4, .4frame, .close').fadeIn('slow');
  });

  $('.5open').on('click', function(){
    $('.overlay5, .5frame, .close').fadeIn('slow');
  });

  $('.6open').on('click', function(){
    $('.overlay6, .6frame, .close').fadeIn('slow');
  });

  
  $('.7open').on('click', function(){
    $('.overlay7, .7frame, .close').fadeIn('slow');
  });

  $('.10open').on('click', function(){
    $('.overlay10, .10frame, .close').fadeIn('slow');
  });

  $('.sorry').on('click', function(){
    $('.overlaysorry, .sorryframe, .close').fadeIn('slow');
  });
